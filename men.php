...
$query = "
    ...
    WHERE c.category_name = 'Men Shoes'
";
...
<div class="shop-layout">
    ...
    <aside class="sidebar">
        ...
        <ul>
            ...
            <li><a href="men.php?type=Partywear">Partywear</a></li>
            <li><a href="men.php?type=Casual">Casual</a></li>
            <li><a href="men.php?type=Sports">Sports</a></li>
            <li><a href="men.php?type=Formal">Formal</a></li>
        </ul>
    </aside>
