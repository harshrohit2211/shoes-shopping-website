...
// Base query (Women Shoes)
$query = "
    SELECT p.* 
    FROM products p
    JOIN categories c ON p.category_id = c.category_id
    WHERE c.category_name = 'kids Shoes'
";
...
<div class="shop-layout">
    ...
    <aside class="sidebar">
        ...
        <ul>
            ...
            <li><a href="kids.php?type=Partywear">Partywear</a></li>
            <li><a href="kids.php?type=Casual">Casual</a></li>
            <li><a href="kids.php?type=Sports">Sports</a></li>
            <li><a href="kids.php?type=Formal">Formal</a></li>
        </ul>
    </aside>
